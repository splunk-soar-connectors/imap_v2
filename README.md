...
**container_id** | optional | Container ID to get email data from. This lookup uses the connector automation account and can read any container available to that account; it does not apply the initiating user's label or ownership scope. | numeric | `phantom container id` |
